...
namespace DBMedilaRepository
{
    public class DBMedilaSystemContext:DbContext
    {
        ...
        public DbSet<ComprobanteB> Boletas{ get; set; }
        public DbSet<ComprobanteF> FacturaS { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new ComprobanteBMap());
            modelBuilder.Configurations.Add(new ComprobanteFMap());
